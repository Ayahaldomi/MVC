...
namespace TASK17_09.Controllers
{
    public class StudentsController : Controller
    {
        ...
        {
            var students = db.Students.Include(s => s.Detail);
        ...
        {
            ViewBag.StudentId = new SelectList(db.StudentDetails, "StudentId", "Address");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "StudentId,StudentName,Age")] Student student)
        {
            ...
            ViewBag.StudentId = new SelectList(db.StudentDetails, "StudentId", "Address", student.StudentId);
            return View(student);
        }
