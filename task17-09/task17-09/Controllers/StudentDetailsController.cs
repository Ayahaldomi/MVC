...
namespace TASK17_09.Controllers
{
    public class StudentDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentId,Address,Email")] StudentDetails studentDetails)
        {
            ...
            ViewBag.StudentId = new SelectList(db.Students, "StudentId", "StudentName", studentDetails.StudentId);
            return View(studentDetails);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentId,Address,Email")] StudentDetails studentDetails)
        {
            if (ModelState.IsValid)
            {
